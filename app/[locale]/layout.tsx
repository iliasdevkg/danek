...
/*
 * Заголовочный шрифт — Inter Tight, а не Manrope.
 *
 * Manrope геометричный и с мягкими окончаниями: он дружелюбный, и именно
 * это делало витрину «детской» ровно так же, как круглые углы. Inter Tight
 * уже, суше и на крупном кегле держит строку плотно — та подача, ради которой
 * кинематографические развороты и набирают заголовок во весь экран.
 *
 * Родство с Inter не случайно: у семейств общие пропорции, поэтому заголовок
 * и текст выглядят одним голосом, а не двумя шрифтами рядом.
 *
 * `optional`, а не `swap`: метрики запасного начертания Next подгоняет сам,
 * но не ширину букв — на кегле в сотню пикселей лишний перенос сдвигает
 * страницу и CLS уходит за порог. Шрифт предзагружен и почти всегда успевает
 * к первой отрисовке; не успел на медленной сети — страница просто останется
 * в запасном начертании и не дёрнется ни разу.
 */
