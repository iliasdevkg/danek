...
insert into public.news (slug, title, excerpt, body, cover_path, published_at, is_published, author_id) values
  ('respublikanskaya-olimpiada',
   ...
   '{"ky":"Математика боюнча республикалык олимпиада аяктады. ДАНЕК окуучулары алтын, күмүш жана коло медалдарга ээ болушту.\n\nОлимпиадага даярдык кадимки сабактын үстүнө курулат.","ru":"Завершилась республиканская олимпиада по математике. Ученики ДАНЕК взяли золото, серебро и бронзу.\n\nПодготовка надстроена над обычным уроком: с пятого класса работает отдельная математическая группа.","en":"The national mathematics olympiad has ended, and DANEK students took gold, silver and bronze."}',
  ...
  ('priem-uchenikov',
   ...
   '{"ky":"Жаңы окуу жылына кабыл алуу башталды. Сайттан арыз калтырыңыз — жумуш күнү ичинде чалабыз.","ru":"Открыт приём в 1–10 классы. Оставьте заявку на сайте — перезвоним в течение рабочего дня и договоримся о встрече.","en":"Admissions to grades 1–10 are open. Leave a request and we will call back within one working day."}',
