...
const DEMO_NEWS: DemoNews[] = [
  {
    ...
    body: t(
      "Математика боюнча республикалык олимпиада аяктады. ДАНЕК окуучулары алтын, күмүш жана коло медалдарга ээ болушту.\n\nОлимпиадага даярдык кадимки сабактын үстүнө курулат: 5-класстан баштап кошумча математика тобу иштейт, ал эми жетишкендер өзүнчө мугалим менен машыгат.\n\n> Медаль — ошол системанын жыйынтыгы, кокустук эмес. Биз бир баланы эмес, бүтүндөй агымды даярдайбыз.\n\nКийинки жылы тандоо мурункудан кеңири болот: кошумча топко 4-класстан баштап кабыл алабыз.",
      "Завершилась республиканская олимпиада по математике. Ученики ДАНЕК взяли золото, серебро и бронзу.\n\nПодготовка к олимпиаде надстроена над обычным уроком: с пятого класса работает дополнительная математическая группа, а те, кто выходит на призовые места, занимаются с преподавателем отдельно.\n\n> Медаль — результат системы, а не случайности. Мы готовим не одного ребёнка, а весь поток.\n\nСо следующего года отбор станет шире: в дополнительную группу будем брать уже с четвёртого класса.",
      "The national mathematics olympiad has ended, and DANEK students took gold, silver and bronze.\n\nOlympiad preparation is built on top of the regular lesson: an extra maths group runs from grade 5.\n\n> A medal is the result of a system, not of luck. We prepare a whole cohort, not a single child.\n\nFrom next year the selection widens: the extra group will take students from grade 4.",
    ),
  ...
  },
  {
    ...
    body: t(
      "Жаңы окуу жылына 1-класстан 10-класска чейин кабыл алуу башталды.\n\nАта-энелер үчүн тартип жөнөкөй: сайттан арыз калтырасыз, биз жумуш күнү ичинде чалабыз жана жолугушууга убакыт белгилейбиз. Жолугушууда мектепти көрсөтөбүз, мугалимдер менен тааныштырабыз жана бардык суроого жооп беребиз.\n\n> Бала болочок классында бир нече сынак күн өткөрөт — баа коюлбайт, басым жасалбайт.\n\nСынак күндөрдөн кийин ата-эне да, бала да чечим кабыл алууга даяр болот.",
      "Открыт приём в 1–10 классы на новый учебный год.\n\nПорядок для родителя простой: вы оставляете заявку на сайте, мы перезваниваем в течение рабочего дня и договариваемся о встрече. На встрече показываем школу, знакомим с учителями и отвечаем на всё, что важно.\n\n> Затем ребёнок проводит несколько пробных дней в будущем классе — без оценок и без давления.\n\nПосле пробных дней решение принимают обе стороны: и семья, и школа понимают, подходят ли они друг другу.",
      "Admissions to grades 1–10 are open for the new school year.\n\nThe process is simple: leave a request on the site, we call back within one working day and arrange a visit.\n\n> Then your child spends a few trial days in their future class — no grades, no pressure.\n\nAfter the trial days both sides decide: the family and the school each see whether they fit.",
    ),
